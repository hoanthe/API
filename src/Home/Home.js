...
import { Badge, Alert, Col, Table, Button, ButtonGroup, Card, CardBody, CardHeader, ListGroup, ListGroupItem, Row } from 'reactstrap';
import TooltipsA from './Tooltips'
                ...
                <Row>
                        ...
                        <Alert color="success">
                            ...
                            <Row>
                                <Col xs="9" md="10">
                                    ...
                                    <span style={{fontSize: "25px"}}>Your schedule for May 06, 2020</span>
                                </Col>
                                <Col xs="3" md="2">
                                ...
                                <Table striped >
                                    ...
                                    <tbody className="text-center">
                                        <tr >
                                            <td>5:00 AM</td>
                                            <td>
                                                <TooltipsA content="test" item="test" colors="success"></TooltipsA>
                                                <TooltipsA content="test" item="bbb" colors="success"></TooltipsA>
                                                <TooltipsA content="test" item="ccc" colors="danger"></TooltipsA>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>5:30 AM</td>
                                        ...
                                        <tr>
                                            <td>6:00 AM</td>
                                            <td>
                                                <TooltipsA content="test" item="test" colors="secondary"></TooltipsA>
                                                <TooltipsA content="test" item="bbb" colors="success"></TooltipsA>
                                                <TooltipsA content="test" item="ccc" colors="danger"></TooltipsA>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <TooltipsA content="test" item="test" colors="success"></TooltipsA>
                                                <TooltipsA content="test" item="bbb"></TooltipsA>
                                                <TooltipsA content="test" item="ccc"></TooltipsA>
                                            </td>
                                        </tr>
                                        <tr >
                                            <td>9:30 AM</td>
                    ...
                    <Col xs="4" md="3">
                        ...
                        <Card>
                            ...
                            <CardBody>
                                <ListGroup>
                                    <ListGroupItem active tag="a" href="#" action className="justify-content-between"><Badge className="float-right" pill>14</Badge>Cras justo odio </ListGroupItem>
                                    <ListGroupItem tag="a" href="#" action className="justify-content-between"><Badge className="float-right" pill>2</Badge>Dapibus ac facilisis in </ListGroupItem>
                                    <ListGroupItem tag="a" href="#" action className="justify-content-between"><Badge className="float-right" pill
                                        color="warning">1</Badge>Morbi leo risus </ListGroupItem>
